...
extern "C" {
#endif
extern void* cvm_load_model(char *graph_fname, char *model_fname);

extern void cvm_free_model(void *model_);

extern int cvm_get_output_length(void *model_);

extern int cvm_predict(void *model_, char *input_data, char *output_data);
/*!
